...
export default function MissionVission() {
  return (
    <section className='w-full px-12 pb-16'>
      ...
      <p className='mt-8 text-2xl'>
        ...
        nam dolorem quasi, iure ipsum omnis blanditiis, libero nostrum
        ...
        Veritatis, odit perferendis obcaecati dolore natus esse voluptas id odio
        velit corrupti ab. Autem nam aliquam nulla ipsa qui rem voluptatem quas
        possimus quidem quibusdam adipisci nemo ratione, laboriosam eveniet.
      </p>
    </section>
  );
}
